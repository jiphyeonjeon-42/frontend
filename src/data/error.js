const getErrorMessage = errorCode => {
  switch (errorCode) {
    ...
    case 104:
      return `비밀번호가 일치하지 않습니다. 로그인에 실패하였습니다.`;
    case 105:
      return `이미 인증된 회원입니다.`;
    case 107:
    ...
    case 304: // 사용자
      return `존재하지 않는 도서입니다. 조회가 불가능합니다.`;
    case 305:
    ...
    case 402:
      return `대출 권한이 없는 사용자입니다. 42 인증 후 대출이 가능합니다.`;
    case 403:
    ...
    case 407:
      return `분실된 책입니다. 대출이 불가능합니다.`;
    case 408:
      return `파손된 책입니다. 대출이 불가능합니다.`;
    case 410:
    ...
    // 사용자
    case 501:
      return `존재하지 않는 도서입니다. 예약이 불가능합니다.`;
    case 502:
      return ``;
    case 503:
